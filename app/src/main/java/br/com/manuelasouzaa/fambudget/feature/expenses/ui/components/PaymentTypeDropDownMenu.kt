...
@Composable
fun PaymentTypeDropDownMenu(
    onPaymentTypeSelected: (PaymentType) -> Unit
) {
    var isExpanded by remember { mutableStateOf(false) }
    var selectedItem by remember { mutableStateOf(PaymentType.CASH) }
        ...
        ExposedDropdownMenu(
            ...
            PaymentType.entries.forEach { type ->
                DropdownMenuItem(
                    ...
                    text = { Text(text = type.label, style = MaterialTheme.typography.labelMedium) },
                    onClick = {
                        isExpanded = false
                        selectedItem = type
